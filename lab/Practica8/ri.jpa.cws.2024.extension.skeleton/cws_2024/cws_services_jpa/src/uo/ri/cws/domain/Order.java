...
public class Order extends BaseEntity {
    ...
    public Order(String code, LocalDate orderedDate, double amount,
    ...
    public String toString() {
        return "Order [code=" + code + ", orderedDate=" + orderedDate
            + ", amount=" + amount + ", receptionDate=" + receptionDate
            + ", state=" + state + "]";
    }
    ...
    public void addSparePartFromSupply(Supply supply) {
        ...
        StateChecks.isTrue(notInOrders(part),
            "ya existe la pieza en un pedido");

        if (part.isUnderStock()) {
            double price = supply.getPrice();
            OrderLine ordeline = new OrderLine(price, part.getQuantityToOrder(),
                part);
